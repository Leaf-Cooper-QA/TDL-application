...
public class IndexPage {
	...
	public void enterPost3(String string) {
		post3.sendKeys(string);
	}
	...
	public void enterPut3(String string) {
		put3.sendKeys(string);
	}
	...
	public String getDeletePara() {
		return deletePara.getText();
	}
